...
- [~] Optional API-key Bearer authentication protects incident/feedback endpoints; markdown reports work, while RBAC, key hashing/rotation, UI and PDF/DOCX remain.
