...
- [~] PII redaction, prompt builder, OpenAI-compatible provider, strict output/action validation, provider fallback and budget guard are present; prompt files, LLM trace persistence and runtime wiring remain.
