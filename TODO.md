...
- [~] Optional API-key Bearer authentication protects incident/feedback endpoints; markdown reports and basic server-rendered dashboard work, while RBAC, key hashing/rotation, filters and PDF/DOCX remain.
