...
- [~] Generic HMAC webhook, Telegram Bot API and Slack Block Kit senders plus Wazuh field normalizer are present and tested; IRIS/TheHive/Jira adapters remain.
